...
from covalent_services.queuer.app.core.config import settings as queuer_settings
from covalent_services.results.app.core.config import settings as results_settings
