...
from covalent_services.results.app.core.config import settings
from covalent_services.results.app.core.get_svc_uri import DataURI
from covalent_services.results.app.schemas.workflow import ResultFormats
...
def delete_result(*, dispatch_id: str) -> Any:
    ...
    filename = _get_result_from_db(dispatch_id, "filename")
    r = requests.delete(DataURI().get_route("/fs/delete"), params={"obj_name": filename})
