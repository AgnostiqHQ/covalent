...
async def test_status_listener_case_1(mocker: mock):
    ...
    sv_mock.retrieve_async = mocker.AsyncMock(return_value=None)
    ...
    sv_mock.retrieve_async.assert_called_once()
...
async def test_status_listener_case_3(mocker: mock):
    ...
    sv_mock = mocker.MagicMock()
    sv_mock.retrieve_async = mocker.AsyncMock(return_value=test_status)
