...
class Result:
    ...
    PENDING_RECONSTRUCTION = RESULT_STATUS.PENDING_RECONSTRUCTION
    RECONSTRUCTION_FAILED = RESULT_STATUS.RECONSTRUCTION_FAILED
    ...
    def __init__(self, lattice: Lattice, dispatch_id: str = "") -> None:
        ...
        self._rebuild_ids = lattice.return_info["electron_ids"]
