...
class BraketQubitExecutor(BaseThreadPoolQExecutor):
    ...
    Usage of this device requires valid AWS credentials as set up following the
    instructions at https://github.com/aws/amazon-braket-sdk-python#prerequisites 
    """
