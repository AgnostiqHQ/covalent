...
def initialize_result_object(
    ...
    we = lattice.get_metadata("workflow_executor")
    we_data = lattice.get_metadata("workflow_executor_data")
    tg.add_node_by_id(-1, name="postprocess", metadata={"executor": we, "executor_data": we_data})
