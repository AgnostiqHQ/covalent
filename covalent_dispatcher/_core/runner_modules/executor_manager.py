...
class _ExecutorManager:
    ...
    def generate_plugins_list(self) -> None:
        ...
        cov_path = os.path.dirname(covalent.executor.__file__)
        print("DEBUG: ", cov_path)
        pkg_plugins_path = os.path.join(cov_path, "executor_plugins")
