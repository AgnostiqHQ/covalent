...
[![apache](https://img.shields.io/badge/License-Apache_License_2.0-blue?color=%235552FF)](https://www.apache.org/licenses/LICENSE-2.0)
 ...
 <div align="center">
  <img src="./doc/source/_static/readme_executor.svg"  alt="hero" style="margin-bottom:20px"/>
 </div>
   ...
   <div style="display: grid;
    ...
    gap: 10px; ">
     <div style=" 
      ...
      padding:20px;
      text-align:center">
       <img src="./doc/source/_static/deployment.svg"  alt="whatiscovalent" style="width:40%"/>
     ...
     <div style=" 
      ...
      padding:20px;
      text-align:center">
       <img src="./doc/source/_static/high_compute.svg"  alt="whatiscovalent" style="width:40%"/>
       <div style="color:#6D7CFF;
        margin:25px 0 0 0;
        font-size:14px;
        font-weight:500">
     ...
     <div style=" 
      ...
      padding:20px;
      text-align:center">
       <img src="./doc/source/_static/computing.svg"  alt="whatiscovalent" style="width:40%"/>
       <div style="color:#6D7CFF;
        margin:25px 0 0 0;
        font-size:14px;
        font-weight:500">
      ...
      padding:20px;
      text-align:center">
       <img src="./doc/source/_static/workflows.svg"  alt="whatiscovalent" style="width:40%"/>
       <div style="color:#6D7CFF;
        margin:25px 0 0 0;
        font-size:14px;
        font-weight:500">
      ...
      padding:20px;
      text-align:center">
       <img src="./doc/source/_static/orchestration.svg"  alt="whatiscovalent" style="width:40%"/>
       <div style="color:#6D7CFF;
        margin:25px 0 0 0;
        font-size:14px;
        font-weight:500">
 ...
 margin:20px 0 0 0;">
  ...
  <div  style="display: grid;
    ...
    <div style=" padding: 10px;">
     ...
     padding:20px 10px;
     height:185px;">
     <img src="./doc/source/_static/mnist.svg" alt="mnist" style="width:100%;"/>
     ...
     padding:20px 10px;
     height:185px;">
     <img src="./doc/source/_static/workflow.svg" alt="mnist" style="width:100%"/>
     <div style="color:#FFF;font-size:16px;">
    ...
    <div style=" padding: 10px;">
     ...
     padding:20px 10px;
     height:185px;">
     <img src="./doc/source/_static/ai.svg" alt="mnist" style="width:100%"/>
     <div style="color:#FFF;font-size:16px;">
 ...
 <div align="center">
  <img src="./doc/source/_static/self.svg" alt="mnist" style="margin-top:38px"/>
 </div>
