...
- Covalent now supports the ability to switch between `Dask` and `Local` executors
- `covalent logs` has now be added to facilitate parsing logs generated by Covalent

History of changes can be viewed in the [Changelog](https://github.com/AgnostiqHQ/covalent/blob/master/CHANGELOG.md).
