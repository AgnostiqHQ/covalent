...
@router.post("/{result_id}/dispatch", status_code=200, response_model=DispatchResponse)
def submit_workflow(
    *,
    result_id: int
) -> Any:
...
@router.post("/{result_id}/cancel", status_code=200, response_model=DispatchResponse)
def cancel_workflow(
    *,
    result_id: int
) -> Any:
...
@router.put("/{result_id}/update", status_code=200, response_model=UpdateWorkFlowResponse)
def update_workflow(
    *,
