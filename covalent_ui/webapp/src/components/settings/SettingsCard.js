...
const SettingsCard = () => {
  ...
  const bodyParams = {
    dispatcher: {
      ...
      db_path:
        '/home/aravindprabaharan/.local/share/covalent/dispatcher_db.sqlite',
    },
  }
  ...
  return (
    <Container maxWidth="xl" sx={{ mb: 4, mt: 7.5, ml: 4 }}>
      ...
      <Grid container spacing={3} sx={{ mt: 4 }}>
        ...
        >
          {/* please check on line 262 in resultListing.js for reference*/}
          <Input
            sx={{
              ml: 'auto',
              px: 1,
                ...
                {_.map(settings_result, function (value, key) {
                  return (
                    <ListItem disablePadding>
                      <ListItemButton
                        onClick={
                          isChildHasList ? () => handleClick(value) : () => {}
                        }
                      >
