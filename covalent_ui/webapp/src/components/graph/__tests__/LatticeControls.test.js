...
describe('lattice toggle buttons', () => {
  ...
  test('should render downward icon', () => {
    const container = reduxRender(
      <App direction={direction} setDirection={setDirection} />
    )
  ...
  test('should render upward icon', () => {
    const container = reduxRender(
      <App direction={direction1} setDirection={setDirection1} />
    )
    const { result } = renderHook(() => (
      <App direction={direction1} setDirection={setDirection1} />
    ))
  ...
  test('should render back icon', () => {
    const container = reduxRender(
      <App direction={direction2} setDirection={setDirection2} />
    )
    const { result } = renderHook(() => (
      <App direction={direction2} setDirection={setDirection2} />
    ))
  ...
  test('should render forward icon', () => {
    const container = reduxRender(
      <App direction={direction3} setDirection={setDirection3} />
    )
    const { result } = renderHook(() => (
      <App direction={direction3} setDirection={setDirection3} />
    ))
