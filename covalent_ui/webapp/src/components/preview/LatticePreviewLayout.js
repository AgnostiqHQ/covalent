...
import LatticeMain from '../result/LatticeMain'
import NotFound from '../NotFound'
import NodeDrawer, { nodeDrawerWidth } from '../result/NodeDrawer'
...
const LatticePreviewLayout = () => {
  ...
  return (
    <>
      <Box sx={{ width: '100vw', height: '100vh', bgcolor: graphBgColor }}>
        <LatticeMain
          graph={lattice.graph}
          hasSelectedNode={!!selectedElectron}
          marginLeft={latticeDrawerWidth}
